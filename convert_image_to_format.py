...
class ConvertImageToFormat(OperationBase):
    ...
    def get_arg_descriptors(cls):
        return [
            ArgumentDescriptor(
                "ImageResource", "External Configuration Directory", "text"),
            ArgumentDescriptor(
                "Destination", "External Configuration Directory", "text"),
            ArgumentDescriptor(
                "Format", "External Configuration Directory", "text"),
            ArgumentDescriptor("Resolution", "The required resolution",
                               "text", default_value_lambda=lambda x:None)
        ]
